  ...
  return (
    ...
    >
      ...
      <div className="relative p-5 flex items-end justify-between gap-4 border-t border-border">
        ...
        <button
          onClick={() => onQuickView?.(product)}
          className="rounded-full border border-border bg-background/50 px-4 py-2 text-xs font-semibold uppercase tracking-wider hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all shrink-0"
        >
          Quick View
        </button>
      </div>
